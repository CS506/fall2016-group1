...
% Should we move this refresh feature to a later sprint?
...
% Is this Bucket section still relevant, considering our chosen schema? Our data is stored in terms of drips, not buckets. I may be missing something, though.
@@@ Bucket
...
% Go ahead and fill in schema details?
