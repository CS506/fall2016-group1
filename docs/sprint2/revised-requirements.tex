...
% Russ, we should probably include the field names in the requirements in the future. 
% Otherwise, we might run into inconsistencies in our design artifacts in how we name
% things.
% If you want to specify names for this sprint, make changes to this file, not the 
% baselined requirements. I think the field names would be added to this section rather
% than the section above, since this section is about the data requirements.
